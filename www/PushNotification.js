...
PushNotification.prototype.setlistener = function(successCallback, errorCallback, options) {
    ...
    cordova.exec(successCallback, errorCallback, "PushPlugin", "setlistener", [options]);
};
